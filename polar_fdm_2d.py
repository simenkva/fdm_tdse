...
class polar_fdm_2d:
    ...
    def __init__(self, r_max, n_r, m_max):
        ...
        self.Rm12 = spdiags(self.r_inner**(-.5), 0, n_r, n_r)
        # Transition from full to reduced wavefunction
        self.R12 = spdiags(self.r_inner**(.5), 0, n_r, n_r)
...
#    H_mat = H_mat_sparse.todense()
    ...
    A = LinearOperator((solver.n_dof, solver.n_dof), matvec=H_mat_sparse.dot, dtype=np.complex128)
